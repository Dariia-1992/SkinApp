...
public class SavedToMinecraftDialog extends DialogFragment {
    ...
    public static SavedToMinecraftDialog createDialog(OnFinishListener listener) {
        SavedToMinecraftDialog dialog = new SavedToMinecraftDialog();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_skin_installed, null, false);
